	...
	public function execute() {
		...
		<div id="mw-navigation">
			...
			<div id="mw-head" style="top:35px;">
				...
				<div id="app-brand-name"  style="background:#6D4E86; position:absolute; top:2px; clear:both; float:left; font-size:24px; color:white; padding:8px 45px 6px 45px;">wiki</div>
