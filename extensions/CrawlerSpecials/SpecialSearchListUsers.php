 ...
 * @ingroup SpecialPage
 */
class UsersCrawlPager extends AlphabeticPager {
 ...
 * @ingroup SpecialPage
 */
class SpecialSearchListUsers extends IncludableSpecialPage {
	/**
	 * Constructor
	 */
	public function __construct() {
		parent::__construct( 'SearchListUsers' );
	}
	...
	public function execute( $par ) {
		...
		$up = new UsersCrawlPager( $this->getContext(), $par, $this->including() );
