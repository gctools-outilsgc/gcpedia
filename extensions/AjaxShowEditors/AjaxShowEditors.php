...
/*$wgResourceModules['ext.AjaxShowEditors'] = array(
	'scripts' => 'AjaxShowEditors.js',
	'position' => 'bottom',
	'localBasePath' => dirname( __FILE__ ),
	'remoteExtPath' => 'AjaxShowEditors',
);*/

// Load the ajax responder and register it
$wgAutoloadClasses['AjaxShowEditorsAPI']	= __DIR__  . '/Response.php';
$wgAPIModules['ashoweditors'] = 'AjaxShowEditorsAPI';
